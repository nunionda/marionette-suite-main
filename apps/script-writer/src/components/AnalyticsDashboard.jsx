  ...
  return (
    <div className="analytics-dashboard" style={{ padding: '30px', background: 'rgba(0,0,0,0.2)', borderRadius: '12px', minHeight: '600px', position: 'relative' }}>
      ...
      <header style={{ marginBottom: '40px', borderLeft: '4px solid var(--accent-primary)', paddingLeft: '20px' }}>
        <h2 style={{ margin: 0, letterSpacing: '4px', textTransform: 'uppercase' }}>NARRATIVE <span style={{ color: 'var(--accent-primary)' }}>VISION</span></h2>
        <p style={{ color: 'var(--text-dim)', fontSize: '0.8rem', letterSpacing: '0.5px' }}>AI-Driven Quantitative Analysis of Emotional Arc and Character Agency</p>
      </header>

      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '30px' }}>
        {/* 1. Emotional Valence Arc */}
        <div className="chart-card glass" style={{ padding: '20px', height: '350px' }}>
          <h4 style={{ marginBottom: '20px', fontSize: '0.8rem', color: 'var(--accent-secondary)', letterSpacing: '1.2px' }}>EMOTIONAL VALENCE ARC</h4>
        ...
        <div className="chart-card glass" style={{ padding: '20px', height: '350px' }}>
          <h4 style={{ marginBottom: '20px', fontSize: '0.8rem', color: 'var(--accent-secondary)', letterSpacing: '1.2px' }}>CHARACTER ARCHETYPE BALANCE</h4>
          <ResponsiveContainer width="100%" height="80%">
