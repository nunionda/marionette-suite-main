...
${analysisContext}
    ...
    try {
      ...
      return {
        ...
        categories: ((parsed.categories as unknown[]) || []) as import('../domain/ScriptCoverage').CoverageCategory[],
        overallScore: (parsed.overallScore as number) || 0,
        verdict: ((parsed.verdict as string) || 'Pass') as import('../domain/ScriptCoverage').Verdict,
