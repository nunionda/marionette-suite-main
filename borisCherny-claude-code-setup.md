---
name :  borisCherny-claude-code-setup process

instruction : I'm Boris and I created Claude Code. Lots of people have asked how I use Claude Code, so I wanted to show off my setup a bit.
...
https://x.com/bcherny/status/2007179840848597422/photo/1

claude-cli $cat CLAUDE.md
# Development workflow
**Always uese `bun` , not `npm`.**
